...
const AccountActivation = () => {
  ...
  const rejectionSubmit = async () => {
    try {
      ...
      const { data } = await axios.put(
        `https://server-deployment-jet.vercel.app/api/admin/activationRequestReject/${user._id}`,
        {
  ...
  const activationSubmit = async () => {
    try {
      ...
      const { data } = await axios.put(
        `https://server-deployment-jet.vercel.app/api/admin/accountActivation/${user._id}`,{},
        config
      );
      console.log(data.data);
