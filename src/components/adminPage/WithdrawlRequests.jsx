...
const WithdrawlRequests = () => {
  ...
  const acceptingWithdrawalRequests = async()=>{
    try {
      ...
      const { data } = await axios.get(
        "https://server-deployment-jet.vercel.app/api/admin/getVariable/acceptingWithdrawalRequests",
        config
      );
  ...
  const fetchAllRequests = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        "https://server-deployment-jet.vercel.app/api/admin/getAllWithdrawalRequests",
        config
      );
  ...
  const downloadRequests = async () => {
    try {
      ...
      const response = await axios.post(
        "https://server-deployment-jet.vercel.app/api/admin/download-pending-requests",
  ...
  const updatePaidStatus = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        "https://server-deployment-jet.vercel.app/api/admin/update-paid-status",
        { ids: idsToUpdate },
        config
      );
      console.log(data);
  ...
  const startAccepting = async()=>{
    try {
      ...
      const { data } = await axios.put(
        "https://server-deployment-jet.vercel.app/api/admin/updateVariable/acceptingWithdrawalRequests",
        {value:true},
        config
      );
