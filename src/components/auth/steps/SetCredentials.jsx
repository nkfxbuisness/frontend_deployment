...
const SetCredentials = () => {
  ...
  const verifyReferralCode = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://server-deployment-jet.vercel.app/api/auth/user/signup/verifyReferralCode",
  ...
  const generateOTP = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://server-deployment-jet.vercel.app/api/auth/user/signup/generateOTP",
  ...
  const resendOTP = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://server-deployment-jet.vercel.app/api/auth/user/signup/resendOTP",
        { email: userData["email"] },
        config
      );
      if (data.success) {
  ...
  const verifyOTP = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        "https://server-deployment-jet.vercel.app/api/auth/user/signup/verifyOTP",
